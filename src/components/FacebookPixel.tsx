...
export const FacebookPixel: FC<IconProps> = ({ width, height, color }) => {
  return (
    <svg
      version='1.0'
      ...
      fill={color ? color : '#3a589b'}
    >
      <g transform='translate(0.000000,400.000000) scale(0.100000,-0.100000)' fill='current' stroke='none'>
        <path
          d='M168 3986 c-64 -17 -116 -60 -142 -115 l-21 -46 0 -1830 0 -1830 22
