...
export const GoogleMaps: FC<IconProps> = ({ width, height, color, simpleIcon }) => {
  return (
    <svg
    ...
    >
      ...
      <g strokeWidth='130' clipPath='url(#a)'>
        <path stroke={simpleIcon ? '#ffffff' : '#fbbc04'} d='M104 379l152-181' />
        <path stroke={simpleIcon ? '#ffffff' : '#4285f4'} d='M256 198L378 53' />
        <path stroke={simpleIcon ? '#ffffff' : '#34a853'} d='M189 459l243-290' />
        <path stroke={simpleIcon ? '#ffffff' : '#1a73e8'} d='M255 120l-79-67' />
        <path stroke={simpleIcon ? '#ffffff' : '#ea4335'} d='M76 232l91-109' />
      </g>
